...
import activities.doctorswall.AddContact;
import activities.doctorswall.app.ContactList;
import activities.doctorswall.app.QRCodeShare;
...
public class NavAct extends AppCompatActivity
    ...
    ImageView btn_addpost, btn_shareContact, btn_addcontact;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_shareContact = (ImageView) findViewById(R.id.img_contactShare);
        btn_shareContact.setOnClickListener(this);

        btn_addcontact = (ImageView) findViewById(R.id.doctor_addfriend);
        ...
        pq.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if(e == null && objects.size() > 0){
                    ...
                    Picasso.with(getApplicationContext()).load(pf.getUrl()).placeholder(R.drawable.default_user_icon).error(R.drawable.default_user_icon).fit().into(wallProfilePic);



                    Picasso.with(getApplicationContext()).load(pf.getUrl()).placeholder(R.drawable.default_user_icon).error(R.drawable.default_user_icon).fit().into(cPf);


                   // Picasso.with(getApplicationContext()).load(wf.getUrl()).placeholder(R.drawable.backdefault).error(R.drawable.backdefault).fit().into(wallimage);
...
refreshPage();    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            ...
            startActivity(new Intent(NavAct.this, ContactList.class));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_contactShare:


                    startActivity(new Intent(NavAct.this, QRCodeShare.class));
            ...
            case R.id.doctor_addfriend:


                startActivity(new Intent(NavAct.this, AddContact.class));
